...
public extension Date {
    ...
    func toString(format: String = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", timezone: TimeZone? = TimeZone.current) -> String {
    ...
    func appendAsString(format: String = "yyyy-MM-dd'T'HH:mm:ss", timezone: TimeZone? = TimeZone.current) -> String {
        let formatter = DateFormatter().apply {
            $0.dateStyle = .short
            $0.dateFormat = format
            $0.timeZone = timezone
